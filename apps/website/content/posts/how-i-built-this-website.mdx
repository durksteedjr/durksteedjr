...
Although Tailwind CSS comes with a predefined set of colors, I am using my [personal color palette (@durksteedjr/colors)](https://colors.durksteedjr.com).

### UI

I am using reusable, React.js components from my [personal UI library (@durksteedjr/ui)](https://ui.durksteedjr.com).

## Content

### MDX

[MDX](https://mdxjs.com) combines Markdown and JSX enabling React.js components within markdown and providing a seamless integration between code and content.
